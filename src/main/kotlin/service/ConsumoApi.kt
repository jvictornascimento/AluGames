...
class ConsumoApi {
    ...
    fun   buscaJogo(id: String?): List<Jogo> {
        ...
        val gson = Gson()
        var meuJogoTipo = object : TypeToken<List<InfoJogosJson>>(){}.type
        val listaJogos :List<InfoJogosJson> = gson.fromJson(json, meuJogoTipo)
        val listaJogosConvertida = listaJogos.map { InfoJogosJson -> InfoJogosJson.criaJogo() }
